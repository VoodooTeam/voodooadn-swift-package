...
enum Constants {
    static var voodooADNURL: String { "https://voodoo-adn-framework.s3.eu-west-1.amazonaws.com/iOS/Prod/3.5.3/VoodooAdn.zip"}
    static var voodooADNChecksum: String { "eff0370a6d4dd60507e9e582a75abff8da76284903d8351711370eae2ff356d4" }
